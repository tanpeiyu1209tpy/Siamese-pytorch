...
# --- 路径配置 ---
# 1. 原始图像 (必须提供，用于裁剪正样本)
ORIGINAL_IMAGES_DIR = Path('/kaggle/input/breast/data/mlo_view/images/train') 
...
DETECT_RUN_DIR = Path('/kaggle/input/siamesedata/siameseD/train/mlo')

# 4. 最终输出的根目录
OUTPUT_ROOT = Path('/kaggle/working/siamese_data_train')
